...
namespace StarterAssets
{
    ...
    public class TPSController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (_input.isShooting && !isInShootingCD)
            {
                Shoot();
            }
        }
        ...
        void Aim()
        {
            ...
            Vector3 aimPos = _mainCamera.GetComponent<Camera>().ViewportToWorldPoint(new Vector3(0.5f,0.5f, 10));
        ...
        private void OnDrawGizmos()
        {
            ...
            //Gizmos.DrawLine(shootOrigin.position, shootOrigin.forward * 10);
        }
